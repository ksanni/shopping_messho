...
export default function Cart() {
  ...
  const total =
    itemPrices.length > 0
      ? itemPrices.reduce((sum, price) => sum + price, 0)
      : 0;
    ...
    return (
      <>
        <div className="emptyCard">
          <h1>Cart is Empty</h1>
            <img src="https://meeshoclonee.netlify.app/static/media/emptyCart.de7f2238ba7b1154ca53.png" alt="not found" />
          <NavLink to="/">
            <div>
                    ...
                    <div className="item_1">
                      ...
                      <div className="details">
                        ...
                        <div className="handle">
                          <button onClick={() => handleDecrease(data)}>
                            -
                          </button>
                          <h4>{data.qty}</h4>
                          <button onClick={() => handleIncrease(data)}>
                            +
                          </button>
                        </div>
                      </div>
                      <div className="buyRemove">
                        <button onClick={(e) => handleRemove(data)}>
                          Remove
                        </button>
                      </div>
                    </div>
